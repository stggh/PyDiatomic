...
# cse ---------------------
X = cse.Cse('S2', VT=['potentials/X3S-1.dat'], en=400)
B = cse.Cse('S2', dirpath='potentials', suffix='.dat',
             VT=['B3S-1', 'Bpp3P1', 'abinitio/Wheeler/5P1',
                 'abinitio/Wheeler/1P1'], coup=[57, 205, 66, *([0]*3)])
                  # JCP 148, 244303 
